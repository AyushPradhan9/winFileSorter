...
Label(win,text="Welcome to the File Sorter",font=("Times",20),height=4,bg="Gray15",fg="White")\
    .grid(row=0,column=0,padx=0,pady=0,sticky=N)
Label(win,text="Select folder to be sorted :",font=("Times",12),width=20,height=1,bg="Gray15",fg="Red")\
    .grid(row=1,column=0,padx=15,pady=10,sticky=W)
label1=Label(win,text=current_path,font=("Times",10),width=65,height=1,bg="Gray23",fg="White")
...
Button(win,text='Browse',font=("Times",10),command=openDir,width=8,height=1,bg="Gray23",fg="White")\
...
Label(win,text="Select type of sorting :",font=("Times",12),width=20,height=1,bg="Gray15",fg="Red")\
    .grid(row=3,column=0,padx=0,pady=10,sticky=W)
Button(win,text='Sort current files',font=("Times",11),command=staticOne,width=35,height=2,bg="Gray23",fg="White")\
    .grid(row=4,column=0,padx=0,pady=10)
Button(win,text="Cotinue sorting upcoming files",font=("Times",11),command=dynamicOne,width=35,height=2,bg="Gray23",fg="White")\
    .grid(row=5,column=0,padx=0,pady=10)
Label(win,text="Continue sorting upcoming files will require to leave app running",font=("Times",12),fg="Red",bg="Gray15")\
    .grid(row=6,column=0,padx=0,pady=10,sticky=N)
Button(win,text="Exit",font=("Times",10),command=sys.exit,width=10,bg="Gray23",fg="White")\
